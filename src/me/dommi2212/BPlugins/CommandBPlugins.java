	...
	public void execute(CommandSender cs, String[] args) {
		...
		if(args.length == 0) {
			...
			if(args[0].equalsIgnoreCase("help")) {
				...
				} else cs.sendMessage(new TextComponent("§cSyntax: /BPlugins help"));
				...
				} else cs.sendMessage(new TextComponent("§cSyntax: /BPlugins reload <Plugin>"));
				...
				} else cs.sendMessage(new TextComponent("§cSyntax: /BPlugins disable <Plugin>"));
				...
				} else cs.sendMessage(new TextComponent("§cSyntax: /BPlugins enable <Plugin>"));
			}	
		} else cs.sendMessage(new TextComponent("§cSyntax Error! Use §o\"/BPlugins help\"§c for help!"));
	}
	
	public static void showPlugins(PluginManager pm, CommandSender cs) {
